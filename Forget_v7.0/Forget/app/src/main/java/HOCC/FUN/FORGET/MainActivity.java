...
SharedPreferences pref=this.getSharedPreferences("MY", MODE_PRIVATE);
        if (pref.getInt("TASK", 0) == 1){
            editText.setText(pref.getString("INPUT_TEXT" , ""));
    ...
    public void openNewActivity() {
        ...
        this.getSharedPreferences("MY", MODE_PRIVATE).edit().putInt("TASK", 1).putString("INPUT_TEXT" , editText.getText().toString()).putInt("LANGUAGE" , lan).putString("LIST" , list.getText().toString()).apply();
